...
async function main() {
  ...
  const features = await runProcess(['--test', '--test-reporter=spec', require.resolve('./features.test.js'), require.resolve('./cues.test.js'), require.resolve('./dynamics.test.js')]);
