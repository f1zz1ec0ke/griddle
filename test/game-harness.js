...
function kitchen(storage = new Map()) {
  ...
  const root = { BurgerAssembly: require('../js/assembly'), TemperatureUnits: require('../js/units'), CookingCues: require('../js/cues'), BurgerPhysics: P, GriddleSession: Session, BurgerRender: { Viewport, nodeColour: () => [0, 0, 0] }, KitchenAudio: Audio,
